...
// Passenger manifests are operational data, not part of the immutable request.
// They can be prepared from acceptance through confirmation, but are frozen while
// cancellation is pending and after the trip reaches a terminal state.
